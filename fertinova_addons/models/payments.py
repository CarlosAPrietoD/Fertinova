...
class AccountPayment(models.Model):
    ...
    invoices_id     = fields.Many2one('account.invoice', string='Factura', compute='_set_invoices')
    purchases_id    = fields.Many2one('purchase.order', string='Orden de Compra', compute='_set_purchases')
