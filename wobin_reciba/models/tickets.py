...
class RecibaTicket(models.Model):
    ...
    def _default_operation_type(self):
        ...
        if self.operation_type=='in':
            ...
            location = self.env['stock.location'].search([('name','=','Proveedores'),('location_id.name','=','Ubicaciones de socios')], limit=1).id
            ...
            location = self.env['stock.location'].search([('name','=','Clientes'),('location_id.name','=','Ubicaciones de socios')], limit=1).id
